...
contract TrustMarketplace is ReentrancyGuard {
    ...
    function createTrustMarketItem(address trustnftContract, uint256 tokenId, uint256 price) public payable nonReentrant {
    ...
    function trustMarketDeal(address trustnftContract, uint256 trustId, uint256 price) public payable nonReentrant {
        ...
        idToMarketItem[trustId].seller.transfer(price);
